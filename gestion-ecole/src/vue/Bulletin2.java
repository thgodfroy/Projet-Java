...
public class Bulletin2 extends JFrame {
    public Bulletin2(String nom,String prenom){
        this.setTitle("Bulletin 2 de "+nom+" "+prenom);
	...
	this.setLocationRelativeTo(null);
        ...
        sql1="SELECT discipline FROM bulletin WHERE id_personne='"+sql+"' AND id-trimestre='2' ";
        
        
        sql2="SELECT moyenne FROM bulletin WHERE id_personne='"+sql+"' AND id-trimestre='2' ";
        
        sql3="SELECT appreciation FROM bulletin WHERE id_personne='"+sql+"' AND id-trimestre='2' ";
